...
- One question per turn. Never batch.** Their answer picks the next; that branching is the design tree.
- Why* before *how*: problem, who for, cost of not building.
- Kill vague words — make "fast/clean/simple/later" name a number or a cut line.
- Name the rejected fork: what did they not do, and why?
- Find the hidden constraint; probe the edges (zero, scale, failure).
- Push back when answers conflict.
